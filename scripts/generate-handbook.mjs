...
const SECTIONS = [
  ...
  { title: 'Data & API', files: ['07-api.md', '08-database.md', '10-state.md', '11-dependency-map.md', '21-integration.md', '22-versions-trash.md', '24-platform-services.md'] },
  { title: 'Security & auth', files: ['09-auth.md', '18-security.md', '23-confidential-informants.md'] },
