 ...
 *  → initials on bg-ink-700), declared once. Consumers today: the
 *  RecordSearchPicker rows; the RegistryCard/Mug call sites migrate in the
 *  avatar-consolidation pass, not here. */
import { useState } from 'react'
import { initials } from '@/lib/format'
import { safeUrl } from '@/lib/safeUrl'

const SIZES = { sm: 'h-8 w-8 text-[10px]', md: 'h-14 w-14 text-sm' } as const
