...
export function CommandCenterView() {
  ...
  if (state !== 'in') {
    return <div className="rounded-2xl border border-white/10 bg-ink-900/60 p-8 text-center text-sm text-slate-400">Sign in to access the Command Center.</div>
  }
  if (!canAccess) {
    return (
  ...
  return (
    <div className="space-y-5">
      <header className="rounded-2xl border border-white/10 bg-ink-900/60 p-5">
