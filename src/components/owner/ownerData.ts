...
export const ENV_VARS: EnvVarDoc[] = [
  ...
  { name: 'PORTAL_MODE', purpose: 'Portal mode switch — normal | readonly | maintenance | retired (server side only; reversible, touches no data)', required: false, usedIn: 'src/proxy.ts, src/lib/portalMode.ts', ifMissing: 'normal — the portal works exactly as it does today' },
