        ...
        {draftBanner && (
          <div className="mb-3 flex flex-wrap items-center justify-between gap-2 rounded-lg border border-amber-500/25 bg-amber-500/10 px-3 py-2">
            ...
            <span className="flex items-center gap-1">
              <button type="button" onClick={discardDraft} className="min-h-[44px] sm:min-h-0 rounded-md px-2 py-1.5 text-xs font-semibold text-amber-200 hover:bg-amber-500/10 hover:text-white">Discard draft</button>
