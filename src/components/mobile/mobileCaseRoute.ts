...
import { CASE_TABS, type CaseTabId } from '@/components/cases/caseTabs'
 ...
 *  those renders a "desktop only" card with the workspace link. */
...
export const isCaseTab = (s: string | null | undefined): s is CaseTabId =>
  !!s && (CASE_TABS as readonly string[]).includes(s)
