...
describe('trash — vocabulary and helpers', () => {
  ...
  it('the kind → table map is the inverse of db.ts SOFT_DELETE_KIND (33 kinds incl. case_packet / external_source / entity_association / guide, never a second vocabulary)', () => {
    ...
    expect(TRASH_KINDS).toHaveLength(33)
