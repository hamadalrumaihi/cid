...
export default function NotFound() {
  return (
    <main className="grid min-h-screen place-items-center bg-ink-950 p-6">
      <div className="w-full max-w-md rounded-lg border border-white/10 bg-ink-900/80 p-8 text-center">
        <p className="font-mono text-5xl font-semibold text-slate-700">404</p>
        <h1 className="mt-2 text-lg font-semibold text-white">No such record</h1>
