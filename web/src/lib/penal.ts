...
export interface PenalCharge {
  code: string; title: string; level: string; jail: number | null; fine: number | null; desc?: string; modifier?: boolean
}
...
export const PENAL_CODE: PenalCharge[] = [
  ...
  { code: "(1)02", title: "Battery, Simple", level: "Misdemeanor", jail: 20, fine: 12000, desc: "Intentionally touching/inflicting bodily harm on another person." },
  { code: "(1)03", title: "Aggravated Assault", level: "Felony", jail: 20, fine: 16000, desc: "Immediate-harm belief with a weapon." },
  { code: "(1)04", title: "Aggravated Battery", level: "Felony", jail: 25, fine: 16000, desc: "Inflicting bodily harm on another person with a weapon." },
  { code: "(1)05", title: "Murder, 1st Degree", level: "Felony", jail: 150, fine: 250000, desc: "Unlawful killing, willful and premeditated." },
  { code: "(1)06", title: "Murder, 2nd Degree", level: "Felony", jail: 90, fine: 200000, desc: "Unlawful killing, willful but not premeditated." },
  { code: "(1)07", title: "Voluntary Manslaughter", level: "Felony", jail: 45, fine: 100000, desc: "Killing in sudden, violent, irresistible passion." },
  { code: "(1)08", title: "Involuntary Manslaughter", level: "Felony", jail: 30, fine: 75000, desc: "Accidental killing due to criminal negligence/recklessness." },
  { code: "(1)09", title: "Attempted Murder", level: "Felony", jail: 60, fine: 110000, desc: "Intentionally attempting to kill or cause great bodily harm." },
  { code: "(1)10", title: "Kidnapping", level: "Felony", jail: 25, fine: 30000, desc: "Taking and moving a person without consent." },
  ...
  { code: "(2)02", title: "Destruction of Government Property", level: "Felony", jail: 30, fine: 50000, desc: "Destroying government-owned property." },
  ...
  { code: "(2)15", title: "Extortion", level: "Felony", jail: 20, fine: 20000, desc: "Obtaining money/favors by threat, force, or blackmail." },
  { code: "(2)16", title: "Robbery", level: "Felony", jail: 20, fine: 15000, desc: "Taking property by threats or force." },
  { code: "(2)17", title: "Aggravated Robbery", level: "Felony", jail: 30, fine: 20000, desc: "Robbery using a deadly weapon." },
  ...
  { code: "(2)20", title: "Laundering", level: "Felony", jail: 15, fine: 15000, desc: "Obtaining or possessing illegal money." },
  ...
  { code: "(2)23", title: "Arson", level: "Felony", jail: 15, fine: 15000, desc: "Willful and malicious burning of property/persons." },
  ...
  { code: "(4)01", title: "Murder of a Peace Officer", level: "Felony", jail: 180, fine: 300000, desc: "Intentional killing of a peace officer." },
  { code: "(4)02", title: "Attempted Murder of a Peace Officer", level: "Felony", jail: 60, fine: 110000, desc: "Attempting to kill/gravely harm a peace officer." },
  { code: "(4)03", title: "Battery of a Peace Officer", level: "Felony", jail: 30, fine: 20000, desc: "Inflicting bodily harm on a peace officer, no weapon." },
  { code: "(4)04", title: "Aggravated Battery of a Peace Officer", level: "Felony", jail: 45, fine: 40000, desc: "Inflicting bodily harm on a peace officer with a weapon." },
  { code: "(4)05", title: "Fleeing and Eluding, Felony", level: "Felony", jail: 30, fine: 30000, desc: "Vehicle flight from LE exceeding 20 MPH over the limit." },
  { code: "(4)06", title: "Fleeing or Eluding, Misdemeanor", level: "Misdemeanor", jail: 15, fine: 20000, desc: "Flight on foot / under 3 minutes." },
  ...
  { code: "(4)13", title: "Bribery", level: "Felony", jail: 15, fine: 10000, desc: "Paying/exchanging services to alter decisions." },
  ...
  { code: "(4)17", title: "Providing False Information", level: "Misdemeanor", jail: 10, fine: 10000, desc: "Knowingly lying to a peace officer." },
  ...
  { code: "(4)23", title: "Contempt of Court", level: "Misdemeanor", jail: null, fine: 10000, desc: "Being disruptive or disrespectful in court (sentence: JUDGE)." },
  ...
  { code: "(4)26", title: "Murder of a Police K-9", level: "Felony", jail: 60, fine: 40000, desc: "Intentional killing of a Police K-9." },
  { code: "(4)27", title: "Attempted Murder of a Police K-9", level: "Felony", jail: 40, fine: 24000, desc: "Attempting to kill or gravely harm a Police K-9." },
  ...
  { code: "(4)29", title: "Murder of a State Official", level: "Felony", jail: 180, fine: 300000, desc: "Intentional killing of a State Official." },
  { code: "(4)30", title: "Attempted Murder of a State Official", level: "Felony", jail: 60, fine: 120000, desc: "Attempting to kill or gravely harm a State Official." },
  { code: "(4)31", title: "Battery of a State Official", level: "Felony", jail: 30, fine: 75000, desc: "Inflicting bodily harm on a State Official, no weapon." },
  { code: "(4)32", title: "Aggravated Battery of a State Official", level: "Felony", jail: 45, fine: 90000, desc: "Inflicting bodily harm on a State Official with a weapon." },
  ...
  { code: "(5)01", title: "Brandishing a Firearm", level: "Misdemeanor", jail: 10, fine: 14000, desc: "Aiming/waving a firearm in a reckless manner." },
  ...
  { code: "(5)05", title: "Possession of a Firearm Alongside Illegal Substances (Modifier)", level: "Felony", jail: 15, fine: 20000, desc: "Possessing a firearm with illegal substances.", modifier: true },
  ...
  { code: "(5)08", title: "Possession of an Illegal Firearm (Class 1)", level: "Felony", jail: 20, fine: 20000, desc: "Possessing an illegal Class 1 firearm/weapon." },
  { code: "(5)09", title: "Possession of an Illegal Firearm (Class 2)", level: "Felony", jail: 30, fine: 70000, desc: "Possessing an illegal Class 2 firearm/weapon." },
  { code: "(5)10", title: "Possession of an Illegal Firearm (Class 3)", level: "Felony", jail: 40, fine: 100000, desc: "Possessing an illegal Class 3 firearm/weapon." },
  ...
  { code: "(6)03", title: "Possession of a Controlled Substance with Intent to Sell (Modifier)", level: "Felony", jail: 30, fine: 75000, desc: "Possessing a controlled substance packaged for distribution.", modifier: true },
  { code: "(6)04", title: "Distribution of a Controlled Substance", level: "Felony", jail: 30, fine: 60000, desc: "Selling a controlled substance to another person." },
  ...
  { code: "(6)08", title: "Under the Influence of Narcotics", level: "Misdemeanor", jail: 10, fine: 5000, desc: "Being in public under the influence of a narcotic." },
  ...
  { code: "(6)10", title: "Public Intoxication", level: "Misdemeanor", jail: 10, fine: 10000, desc: "Being in public under the influence of alcohol." },
  { code: "(6)11", title: "Trafficking Narcotics, First Degree", level: "Felony", jail: 45, fine: 50000, desc: "Transporting 16oz (448g)+ of any controlled substance incl. marijuana." },
  { code: "(6)12", title: "Trafficking Narcotics, Second Degree", level: "Felony", jail: 30, fine: 40000, desc: "Transporting 4oz\u201316oz of any controlled substance excl. marijuana." },
  ...
  { code: "(6)14", title: "Unlicensed Distribution of Distilled Spirits", level: "Misdemeanor", jail: 25, fine: 20000, desc: "Unlicensed sale of distilled spirits (moonshine)." },
  { code: "(7)01", title: "Animal Abuse", level: "Felony", jail: 30, fine: 20000, desc: "Physically abusing or neglecting an animal." },
  ...
  { code: "(9)13", title: "Reckless Driving", level: "Felony", jail: 15, fine: 15000, desc: "Operating with total disregard for public safety." },
  ...
  { code: "(9)23", title: "Driving Under the Influence [DUI]", level: "Misdemeanor", jail: 10, fine: 6000, desc: "Operating under the influence (over 35%); FST/PBT or BaC \u22650.08% satisfies." },
  ...
  { code: "(10)01", title: "RICO Conspiracy (Modifier)", level: "Capital", jail: null, fine: 150000, desc: "Organized agreement to commit an illegal act (sentence: JUDGE).", modifier: true },
  { code: "(10)02", title: "RICO Murder (Modifier)", level: "Capital", jail: null, fine: 500000, desc: "Unlawful killing as part of a criminal organization (sentence: JUDGE).", modifier: true },
  { code: "(10)03", title: "RICO Robbery (Modifier)", level: "Capital", jail: null, fine: 100000, desc: "Taking property by force as part of a criminal organization (sentence: JUDGE).", modifier: true },
  { code: "(10)04", title: "RICO Bribery (Modifier)", level: "Capital", jail: null, fine: 75000, desc: "Bribery as part of a criminal organization (sentence: JUDGE).", modifier: true },
  { code: "(10)05", title: "RICO Trafficking (Modifier)", level: "Capital", jail: null, fine: 80000, desc: "Trafficking 16oz+ as part of a criminal organization (sentence: JUDGE).", modifier: true },
  { code: "(10)06", title: "RICO Kidnapping (Modifier)", level: "Capital", jail: null, fine: 50000, desc: "Kidnapping as part of a criminal organization (sentence: JUDGE).", modifier: true },
]

export const chargeByCode = (code: string) => PENAL_CODE.find((c) => c.code === code)
